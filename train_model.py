"""
train_model.py - CNN Model Training Module
Handles all model architecture, training, and evaluation logic.
...
class ProgressCallback(keras.callbacks.Callback):
    ...
    def __init__(self, log_path: str = "models/training_log.json", total_epochs: int = 20):
        super().__init__()
...
def train(dataset_dir: str = "dataset", epochs: int = 20, val_split: float = 0.2):
    ...
    try:
        _write_status("initializing", "Loading dataset and building model…")
...
def predict_image(img_array: np.ndarray):
    ...
    # model always outputs softmax probabilities regardless of class count
